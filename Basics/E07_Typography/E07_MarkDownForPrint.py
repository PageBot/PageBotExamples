...
for n in range(1, NUM_PAGES+1):
    ...
    c1 = newText(w=CW, name='c1', parent=page, nextElement='c2',
    ...
    # the third column.
    c2 = newText(w=CW, name='c2', parent=page, nextElement='c3',
    ...
    c3 = newText(w=CW, name='c3', parent=page, nextElement='c1', nextPage=n+1,
