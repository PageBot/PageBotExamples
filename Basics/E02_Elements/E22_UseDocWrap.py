...
def draw(contextName):
    exportPath1 = '%s/%s-%s-%s.pdf' % (EXPORT, FILENAME, 'embedded', contextName)
    exportPath2 = '%s/%s-%s.pdf' % (EXPORT, FILENAME, contextName)
    ...
    embeddedDoc.export(exportPath1)
