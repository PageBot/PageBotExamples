...
for contextName in ('DrawBot', 'Flat'):
	...
	FILE_NAME = '_export/05_FitCircleByContext%s.pdf' % contextName
	...
	conditions = [Fit2Width(), Center2Center(), Middle2Middle()]
	newCircle(parent=page, conditions=conditions, fill=color(1,0.2,0.5), stroke=noColor)
	conditions = [Fit2Height(), Center2Center(), Middle2Middle()]
	newCircle(parent=page, conditions=conditions, fill=color(1,0,0), stroke=noColor)
