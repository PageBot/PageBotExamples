...
def compose_People(magazine, part, doc):
    ...
    for page in part.elements:
        ...
        if page.isPage:
            ...
            if index == 2:
                composePeopleTitleLeft(magazine, part, doc, page, index)
            elif index == 3:
                composePeopleTitleRight(magazine, part, doc, page, index)
            else:
                composePeopleTitle(magazine, part, doc, page, index)
            page.solve()
            index += 1
